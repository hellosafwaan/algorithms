...
Last updated: 2026-08-05 (Minimum Operations to Reduce X to Zero, LC 1658, bonus)
...
| # | Problem | Difficulty | LC | Pattern | Status | Solved | Learnings |
|---|---------|------------|----|---------|--------|--------|-----------|
| 1 | Binary Search | Easy | [#704](https://leetcode.com/problems/binary-search/) | Binary Search | ✅ | 2026-07-14 | [→](binary-search/704-binary-search/learnings.md) |
...
| 8 *(bonus)* | Count Days Without Meetings | Medium | [#3169](https://leetcode.com/problems/count-days-without-meetings/) | Intervals | ✅ | 2026-07-12 | [→](intervals/3169-count-days-without-meetings/learnings.md) |
