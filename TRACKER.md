...
| # | Problem | Difficulty | LC | Pattern | Status | Learnings |
|---|---------|------------|----|---------|--------|-----------|
| 1 | Valid Palindrome | Easy | [#125](https://leetcode.com/problems/valid-palindrome/) | Two Pointers | ⚠️ Slow (5th pct) | [→](strings/125-valid-palindrome/learnings.md) |
...
| # | Problem | Difficulty | LC | Pattern | Status | Learnings |
|---|---------|------------|----|---------|--------|-----------|
| 1 | Single Number | Easy | [#136](https://leetcode.com/problems/single-number/) | Bit Manipulation | ⏳ | — |
