...
| DFS vs BFS cold — on the next graph/tree traversal problem, can he identify which it is by pointing at the data structure (stack vs queue), without the sequential-calls-look-like-a-layer confusion resurfacing? | Graphs — traversal identification | 200 | open — misconception surfaced and corrected via call-stack trace 2026-07-05; probe at LC 102 or LC 695 |
